...
//   data = [],
//   loading = false,
//   rowsPerPage = 5, // 👈 default 5 rows per page
// }) {
...
//           {/* Pagination Footer */}
//           {totalPages > 1 && (
//             <div className="flex items-center justify-between border-t px-4 py-3 bg-gray-50 text-sm">
      ...
      <div className="flex items-center justify-between">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" className="w-40">
            ...
            <DropdownMenuItem onClick={() => handleFilter("thisMonth")}>
              This Month
            </DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
